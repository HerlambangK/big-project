  ...
  return (
    <div className="mt-24 flex flex-col items-center justify-center sm:mt-32 xl:mt-60">
      <Image
        ...
        quality={100}
      />
      <motion.h1 className='mt-8 w-full text-center text-[28px] font-bold leading-snug text-[#1B1A1E] md:w-4/6 md:text-[32px] lg:text-[42px]'>Bikin Website jadi mudah tingkatkan bisnis mu sekarang !</motion.h1>
